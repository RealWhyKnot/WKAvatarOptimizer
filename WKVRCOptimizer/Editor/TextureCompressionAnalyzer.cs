...
namespace WKVRCOptimizer.Editor
{
    public class TextureCompressionAnalyzer : EditorWindow
    {
        ...
        [MenuItem("Tools/whyknot/Texture Compression Analyzer")]
        static void Init()
        {
        ...
        private float CalculatePSNR(Texture2D reference, Texture2D target, bool isNormalMap, bool sRGB, int mipLevel, bool derivative)
        {
            ...
            var mseMaterial = new Material(Shader.Find("whyknot/TextureAnalyzer/MeanSquaredError"));
            ...
            var copyMaterial = new Material(Shader.Find("whyknot/TextureAnalyzer/Copy"));
        ...
        private float CalculateSSIM(Texture2D reference, Texture2D target, bool isNormalMap, bool sRGB, int mipLevel, bool derivative)
        {
            ...
            var ssimMaterial = new Material(Shader.Find("whyknot/TextureAnalyzer/SSIM"));
        ...
        public void OnGUI()
        {
            ...
            {
                assetRootPath = "Assets/WKVRCOptimizer";
